...
const MyNavBar = () => {
    return ( <
        ...
        >
        <
        Button variant = "warning" > < img className = "img-lupa"
        src = "https://image.flaticon.com/icons/png/512/64/64673.png"
        alt = "lupa" / > < /Button> <
        /Form> <
        a href = "https://www.mercadolibre.com/" > < img className = "img-carro"
        src = "https://latgchallenge.com/assets/images/logos_slider/cart.png"
        alt = "dazos" / > < /a> <
        /Navbar>
    );
}