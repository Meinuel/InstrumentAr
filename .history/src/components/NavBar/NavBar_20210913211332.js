    ...
    return (
        <Navbar bg="dark" variant="dark">
            ...
            <Form className="d-flex">
                <NavDropdown title="All" variant = "light" id="navbarScrollingDropdown">
                    ...
                    <FormControl
                        ...
                        aria-label="Search"
                    />
                    <Button variant="warning"><img className = "imgLupa" src="https://image.flaticon.com/icons/png/512/64/64673.png" alt="lupa" /></Button>
            </Form>
        </Navbar>
    );
}
