            ...
            <Form className="d-flex">
                <NavDropdown title="All" id="navbarScrollingDropdown">
                    ...
                    <FormControl
                        ...
                        aria-label="Search"
                    />
                    <Button variant="outline-success"><img src="https://png.pngtree.com/png-vector/20190801/ourlarge/pngtree-magnifying-glass-icon-png-image_1644200.jpg" alt="lupa" /></Button>
            </Form>
        </Navbar>
    );
}
